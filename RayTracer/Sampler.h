...
public:
	...
	virtual glm::vec3 value(const glm::vec2& uv, const glm::vec3& p) const override { return color; }
...
public:
	...
	CheckerSampler(std::shared_ptr<Sampler> even, std::shared_ptr<Sampler> odd, float scale = 1) : even{ even }, odd{ odd }, scale{ scale } {}
