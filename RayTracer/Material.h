...
public:
	...
	virtual bool Scatter(const ray_t& ray, const raycastHit_t& hit, glm::vec3& attenuation, ray_t& scattered) const override { return false; }
	virtual glm::vec3 Emitter(const glm::vec2& uv, const glm::vec3& point) { return emission->value(uv, point); }
